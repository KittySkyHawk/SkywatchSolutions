...
def optimize_area_group(gdfclean,quote_type,resolution, minarea,detail,filepath=''):
    ...
    if quote_type == "Tasking":
        if detail == 'high':
            ...
            radius=5000  #radius to buffer in iteration (in m)
            #print(f'Tasking')
            minarea=144
            #radius=300  #radius to buffer in iteration (in m)
            buffer_interval=12
        ...
        while len(factorlist)<=3:
            ...
            for i in range(1, divideby+2):
                ...
                if divide%i==0:
                    ...
                    print((divideby)%i)
                    factorlist.append(i)
                    print(f'new factorlist length is {len(factorlist)} with {i}')
            divideby=divide
        if len(factorlist)==4:
            factorsplit=[]
            factorsplit.append(factorlist[1])
...
#             factorsplit.append(factorlist[2])
            ...
            factorsplit=[]
            factorsplit.append(factorlist[6])
            factorsplit.append(factorlist[-7])
